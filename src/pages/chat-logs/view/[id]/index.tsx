...
import { getChatLogById } from 'apiSdk/chat-logs';
import { ChatLogInterface } from 'interfaces/chat-log';

function ChatLogViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('chat_log', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/chat-logs/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Log Message" text={data?.log_message} />
