...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`VOC (Virtual Online Chatbot)`}</title>

        <meta
          name="description"
          content="Welcome to VOC - Virtual Online Chatbot, your AI-powered companion, skillfully crafted with Dialogflow API to redefine and enhance your communication experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1675865254433-6ba341f0f00b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0Ym90fGVufDB8fHx8MTY5NTQ5NDA1OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`VOC (Virtual Online Chatbot)`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to VOC - Virtual Online Chatbot, your AI-powered companion, skillfully crafted with Dialogflow API to redefine and enhance your communication experience.`}
            </Text>
            <Box
